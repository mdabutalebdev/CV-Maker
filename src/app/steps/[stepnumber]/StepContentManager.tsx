...
export default function StepContentManager() {
    ...
    switch (stepId) {
        case 1:
            CurrentFormComponent = PersonalInformation; 
            break;
        case 2:
            CurrentFormComponent = CareerSummary; 
            break;
        case 3:
            CurrentFormComponent = SkillAndExperiance; 
            break;
        case 4:
            CurrentFormComponent = EduceationAndCertificeation; 
            break;
        case 5:
            CurrentFormComponent = ContactInformation; 
            break;
        case 6:
            CurrentFormComponent = AiResumeGenaration; 
            break;
        case 7:
            CurrentFormComponent = ReviewAndDownload; 
            break;
